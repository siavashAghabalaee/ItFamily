...
class HomeFragment : Fragment() {
    ...
    private fun getHomeData() {
        ...
        Server.getInstance(context!!).getHome(PublicMethods.getAppVersion(context!!),"Android",rootView.loader_home,
            Callback.Home {
                Log.i("aeaijwdaiojd","ok")
                var adapter = HomeAdapters(activity,it.sliderContents,it.video,it.podcasts,it.blogContent,it.magzines)
