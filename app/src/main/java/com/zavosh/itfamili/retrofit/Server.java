...
import com.zavosh.itfamili.retrofit.mymodels.zavoshchecker.CheckResponse;
import com.zavosh.itfamili.retrofit.mymodels.zavoshchecker.RequestsManager;
...
public class Server implements RequestsManager {
    ...
    public void sendPhone(String phone, final ProgressBar loader,
                          final com.zavosh.itfamili.retrofit.mymodels.Callback.Register callback) {
        this.loader = loader;
    ...
    public void sendVerifyCode(String tokenId, String activationCode, String deviceId, String deviceModel, String osType, String osVersion, final ProgressBar loader,
                               final com.zavosh.itfamili.retrofit.mymodels.Callback.VerfyCode callback) {
        this.loader = loader;
        this.loader.setVisibility(View.VISIBLE);
    ...
    public void getHome(String version, String osType, final ProgressBar loader
            , final com.zavosh.itfamili.retrofit.mymodels.Callback.Home callback) {
        this.loader = loader;
    ...
    //id = 4
    public void sendProfile(String fullName, String email, String isMail, final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.PostProfile callback) {
        this.loader = loader;
    ...
    //id = 5
    public void getMagazineList(final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.MagazineList callback) {
        this.loader = loader;
    ...
    //id = 6
    public void getBlogList(final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.BlogList callback) {
        this.loader = loader;
    ...
    //id = 7
    public void getVideoList(final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.VideoList callback) {
        this.loader = loader;
    ...
    //id = 8
    public void getPodcastList(final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.PodcastList callback) {
        this.loader = loader;
    ...
    //id = 9
    public void getQuestionList(final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.QuestionList callback) {
        this.loader = loader;
    ...
    //id = 10
    public void postQuestion(String subject, String message, final ProgressBar loader, final com.zavosh.itfamili.retrofit.mymodels.Callback.PostQuestion callback) {
        this.loader = loader;
...
//                    Log.i("isChangeLikeStatus","ok");
    ...
    //id = 12
    public void getComments(String id, int page, com.zavosh.itfamili.retrofit.mymodels.Callback.GetComment callback) {
        this.idComment = id;
        this.page = page;
    ...
    //id = 13
    public void sendComment(String idCommentSend, String comment, com.zavosh.itfamili.retrofit.mymodels.Callback.SendComment callback) {
    ...
    //id = 14
    public void getContentGroupList(ProgressBar loader,com.zavosh.itfamili.retrofit.mymodels.Callback.SetContentList callback) {
    ...
    //id = 15
    public void getGroup(ProgressBar loader,String id,com.zavosh.itfamili.retrofit.mymodels.Callback.SetGroupDetails callback) {
    ...
    private com.zavosh.itfamili.retrofit.mymodels.Callback.Home callbackHome;
    //4
    private String fullName;
    private String email;
    private String isMail;
    private com.zavosh.itfamili.retrofit.mymodels.Callback.PostProfile postProfileCallback;
    //5
    private com.zavosh.itfamili.retrofit.mymodels.Callback.MagazineList magazineListCallback;
    //6
    private com.zavosh.itfamili.retrofit.mymodels.Callback.BlogList blogListCallback;
    //7
    private com.zavosh.itfamili.retrofit.mymodels.Callback.VideoList videoListCallback;
    //8
    private com.zavosh.itfamili.retrofit.mymodels.Callback.PodcastList podcastListCallback;
    //9
    private com.zavosh.itfamili.retrofit.mymodels.Callback.QuestionList questionListCallback;
    //10
    private String subject;
    private String message;
    private com.zavosh.itfamili.retrofit.mymodels.Callback.PostQuestion postQuestionCallback;
    //11
    ...
    private int page;
    private com.zavosh.itfamili.retrofit.mymodels.Callback.GetComment getCommentCallback;
    //13
    private String idCommentSend;
    private String comment;
    private com.zavosh.itfamili.retrofit.mymodels.Callback.SendComment sendCommentCallback;
    //14
    private com.zavosh.itfamili.retrofit.mymodels.Callback.SetContentList contentGooupListCallback;
    //15
    private com.zavosh.itfamili.retrofit.mymodels.Callback.SetGroupDetails setGroupDetails;
    private String id;
}
